...
describe('test Menu and MenuItem component in horizontal mode', () => {
  ...
  it('should render the correct default Menu and MenuItem based on default props', () => {
    expect(menuElement).toBeInTheDocument()
    expect(menuElement).toHaveClass('lighting-menu test')
