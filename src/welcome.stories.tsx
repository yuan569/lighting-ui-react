    ...
    return (
      <>
        ...
        <ul>
          ...
          <li>支持 TypeScript </li>
          <li>使用开源图标库<a href='https://feathericons.com/' target='_blank'> Feather-Icons</a>。文档地址：<a href='https://www.npmjs.com/package/@ailibs/feather-react-ts' target='_blank'> Github</a></li>
          <li>使用Sass组织样式。</li>
